...
-- changeset Syed_Ehtesham:1703354497342-1
CREATE TABLE "users" ("user_id" UUID NOT NULL, "age" INTEGER, "disability" VARCHAR(255), "email" VARCHAR(255) NOT NULL, "gender" VARCHAR(255), "goals" INTEGER, "location" VARCHAR(255), "full_name" VARCHAR(255), "password" VARCHAR(255) NOT NULL, "reliability" VARCHAR(255), "role" VARCHAR(255), "runs" INTEGER, "fref" INTEGER, CONSTRAINT "users_pkey" PRIMARY KEY ("user_id"));

-- changeset Syed_Ehtesham:1703354497342-2
ALTER TABLE "users" ADD CONSTRAINT "uk_6dotkott2kjsp8vw4d0m25fb7" UNIQUE ("email");

-- changeset Syed_Ehtesham:1703354497342-3
ALTER TABLE "users" ADD CONSTRAINT "uk_r53o2ojjw4fikudfnsuuga336" UNIQUE ("password");

-- changeset Syed_Ehtesham:1703354497342-4
...
-- changeset Syed_Ehtesham:1703354497342-5
...
-- changeset Syed_Ehtesham:1703354497342-11
